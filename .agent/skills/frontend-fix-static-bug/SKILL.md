---
name: frontend_fix_static_bug
description: Fix static analysis errors in frontend code without changing logic.
---

# Frontend Fix Static Bug

## Goal
Given a static error report for frontend code, make minimal edits that resolve syntax or type errors without affecting application logic.
...
## Allowed Actions
- Edit code files under frontend directory.
