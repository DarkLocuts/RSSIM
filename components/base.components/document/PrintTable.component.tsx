...
import { UseResourceProps, useTable } from "@utils";
...
export function PrintTable({ fetchControl, columnControl, title }: { fetchControl: UseResourceProps; columnControl?: ColumnControl[]; title?: string; }) {
