...
const BottomSheet = ({
  ...
  return (
    <>
      ...
      <div
        ref={sheetRef}
        className="isolate fixed left-0 right-0 w-full h-full z-99 transition-[top] duration-75"
        style={{
        ...
        {...bindMouse}
      >
        <div className="w-full h-full bg-white rounded-t-2xl shadow-xl overflow-hidden">
