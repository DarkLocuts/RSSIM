...
function SidebarWrapper({
  ...
  return (
    <Link href={path} prefetch={false} className="block">
      {children}
    </Link>
  );
}
...
export function SidebarComponent({
  ...
  const styles = {
    ...
    base: cn(
      "flex flex-col fixed w-full sm:w-64 h-screen px-2 py-4 overflow-y-auto bg-white z-20 rounded-r-[8px] border-r",
    ...
    item: "flex items-center justify-between px-2 py-4 gap-2 transition-colors duration-300 transform hover:text-primary cursor-pointer transition-none",
